...
class ParameterValidationError(Exception):
    ...
    @classmethod
    def missing_parameter(cls, parameter_name: str, parameter_type: str, context: str | None = None) -> "ParameterValidationError":
    ...
    @classmethod
    def wrong_type(cls, parameter_name: str, expected_type: str, actual_value: Any, context: str | None = None) -> "ParameterValidationError":
    ...
    @classmethod
    def out_of_range(cls, parameter_name: str, valid_range: str, actual_value: Any, context: str | None = None) -> "ParameterValidationError":
    ...
    @classmethod
    def incompatible_parameters(cls, parameter_names: list, issue_description: str, suggested_fix: str, context: str | None = None) -> "ParameterValidationError":
    ...
    @classmethod
    def invalid_normalization(cls, norm_value: Any, supported_norms: list, context: str | None = None) -> "ParameterValidationError":
