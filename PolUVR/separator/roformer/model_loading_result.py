...
class ModelLoadingResult:
    ...
    success: bool
    model: Any | None = None  # Actual model instance (torch.nn.Module)
    ...
    config_used: Any | None = None  # The configuration that was actually used
    ...
    def get_model_parameters_count(self) -> int | None:
    ...
    def get_model_size_mb(self) -> float | None:
