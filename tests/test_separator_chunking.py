...
from PolUVR.separator.separator import Separator
...
class TestSeparatorChunking:
    ...
    @patch('PolUVR.separator.audio_chunking.AudioChunker')
    def test_process_with_chunking_2_stems(self, mock_chunker_class):
        ...
        from PolUVR.separator.separator import Separator as RealSeparator
