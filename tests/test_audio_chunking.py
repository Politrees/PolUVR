...
from PolUVR.separator.audio_chunking import AudioChunker
...
class TestAudioChunker:
    ...
    @patch('PolUVR.separator.audio_chunking.AudioSegment.from_file')
    @patch('PolUVR.separator.audio_chunking.os.path.exists')
    @patch('PolUVR.separator.audio_chunking.os.makedirs')
    ...
    def test_merge_chunks_basic(self, mock_exists, mock_from_file, tmp_path):
        ...
        with patch('PolUVR.separator.audio_chunking.AudioSegment.empty') as mock_empty:
